...
def saveData():
    ...
    it before.
    """
    with open('./vmed/doc_vmed11/resultvmed.txt', 'a+') as filerecord:
...
def readerFile():
    ...
    """
    with open('./vmed/doc_vmed11/resultvmed.txt', 'r') as filereader:
...
importationFile('./vmed/doc_vmed11/resultvmed.txt',
    encodage="Utf-8")
