...
def saveData():
    ...
    it before.
    """
    with open('./vmed/doc_vmed16/resultvmed.txt', 'a+') as filerecord:
...
def readerFile():
    ...
    """
    with open('./vmed/doc_vmed16/resultvmed.txt', 'r') as filereader:
...
importationFile('./vmed/doc_vmed16/resultvmed.txt',
    encodage="Utf-8")
