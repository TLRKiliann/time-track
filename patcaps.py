...
def callResident(self):
    ...
    self.b11=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
    ...
    self.b12=Button(self.can, width=18, font=16, bg='black', fg='cyan',
    ...
    self.b15=Button(self.can, width=10, font=15, bg='black', fg='cyan',
    ...
    self.b31=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
        command=self.allergyLink3)
    self.fb31=self.can.create_window(self.x31, self.y31, window=self.b31)

    self.x32, self.y32 = 429, 294
    self.b32=Button(self.can, width=18, font=16, bg='black', fg='cyan',
        activebackground='dark turquoise', text="Diagnostic + ATCD",
        command=self.diag3)
    ...
    self.b51=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
        command=self.allergyLink5)
    self.fb51=self.can.create_window(self.x51, self.y51, window=self.b51)

    self.x52, self.y52 = 429, 358
    self.b52=Button(self.can, width=18, font=16, bg='black', fg='cyan',
        activebackground='dark turquoise', text="Diagnostic + ATCD",
        command=self.diag5)
    ...
    self.b71=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b91=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b101=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b105=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed10)
    self.fb105=self.can.create_window(self.x105, self.y105, window=self.b105)

    self.x106, self.y106 = 981, 518
    self.b106=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b107=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b111=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b121=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b125=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed12)
    self.fb125=self.can.create_window(self.x125, self.y125, window=self.b125)

    self.x126, self.y126 = 981, 582
    self.b126=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b127=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b131=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b141=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b145=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed14)
    self.fb145=self.can.create_window(self.x145, self.y145, window=self.b145)

    self.x146, self.y146 = 981, 646
    self.b146=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b147=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b151=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b161=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b165=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed16)
    self.fb165=self.can.create_window(self.x165, self.y165, window=self.b165)

    self.x166, self.y166 = 981, 710
    self.b166=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b167=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b171=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b181=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b185=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed18)
    self.fb185=self.can.create_window(self.x185, self.y185, window=self.b185)

    self.x186, self.y186 = 981, 774
    self.b186=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b187=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b191=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b201=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b205=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed20)
    self.fb205=self.can.create_window(self.x205, self.y205, window=self.b205)

    self.x206, self.y206 = 981, 838
    self.b206=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b207=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b211=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b221=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b225=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed22)
    self.fb225=self.can.create_window(self.x225, self.y225, window=self.b225)

    self.x226, self.y226 = 981, 902
    self.b226=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b227=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
    ...
    self.b231=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b241=Button(self.can, width=8, font=16, bg='blue violet', fg='coral',
        activebackground='dark turquoise', text="Allergy",
    ...
    self.b245=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Medical Visit",
        command=self.visitMed24)
    self.fb245=self.can.create_window(self.x245, self.y245, window=self.b245)

    self.x246, self.y246 = 981, 966
    self.b246=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="Intolerance",
    ...
    self.b247=Button(self.can, width=10, font=16, bg='slate blue', fg='cyan',
        activebackground='dark turquoise', text="BMI",
