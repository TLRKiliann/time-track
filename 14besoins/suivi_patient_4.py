...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        try:        
            if os.path.getsize('./labo/doc_labo/result4.txt'):
                print("+ File 'result4.txt' exist !")
        except FileNotFoundError as outcom:
            print("+ Sorry, file 'result4.txt' not exist !", outcom)
    ...
    def lectureFic(self):
        ...
        try:        
            ...
            print("+ Sorry, file 'result4.txt' not exist !", outputcomment)
            self.commentFileRecResult()
    ...
    def commentFileRecResult(self):
        self.MsgBox2msg = messagebox.showinfo("Warning", "File 'result4.txt'"
            "was not created. Check options to 'labo' !")
        self.createFileLabo()

    def createFileLabo(self):
        with open('./labo/doc_labo/result4.txt', 'w') as filelab:
            filelab.write("\n---\n")
