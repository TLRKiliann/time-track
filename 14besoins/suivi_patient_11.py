...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        try:        
            ...
            print("+ Sorry, file 'result11.txt' not exist !", outcom)
    ...
    def lectureFic(self):
        ...
        try:        
            ...
            print("+ Sorry, file 'result11.txt' not exist !", outputcomment)
            self.commentFileRecResult()
    ...
    def commentFileRecResult(self):
        self.MsgBox2msg = messagebox.showinfo("Warning", "File 'result11.txt'"
            "was not created. Check options to 'labo' !")
        self.createFileLabo()

    def createFileLabo(self):
        with open('./labo/doc_labo/result11.txt', 'w') as filelab:
            filelab.write("\n---\n")
