...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        try:
            if os.path.getsize('./14besoins/doc_suivi21/patient21_14b.txt'):
                ...
                subprocess.call('./14besoins/doc_suivi21/patient21_write.py')
        ...
        try:        
            ...
            print("+ Sorry, file 'result21.txt' not exist !", outcom)
    ...
    def lectureFic(self):
        ...
        try:        
            ...
            print("+ Sorry, file 'result21.txt' not exist !", outputcomment)
            self.commentFileRecResult()
    ...
    def commentFileRecResult(self):
        self.MsgBox2msg = messagebox.showinfo("Warning", "File 'result21.txt'"
            "was not created. Check options to 'labo' !")
        self.createFileLabo()

    def createFileLabo(self):
        with open('./labo/doc_labo/result21.txt', 'w') as filelab:
            filelab.write("\n---\n")
