...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        try:
            if os.path.getsize('./14besoins/doc_suivi18/patient18_14b.txt'):
                ...
                subprocess.call('./14besoins/doc_suivi18/patient18_write.py')
        ...
        try:        
            ...
            print("+ Sorry, file 'result18.txt' not exist !", outcom)
    ...
    def lectureFic(self):
        ...
        try:        
            ...
            print("+ Sorry, file 'result18.txt' not exist !", outputcomment)
            self.commentFileRecResult()
    ...
    def commentFileRecResult(self):
        self.MsgBox2msg = messagebox.showinfo("Warning", "File 'result18.txt'"
            "was not created. Check options to 'labo' !")
        self.createFileLabo()

    def createFileLabo(self):
        with open('./labo/doc_labo/result18.txt', 'w') as filelab:
            filelab.write("\n---\n")
