...
def saveData():
    """
    To record data from result6.txt
    and from patient6_14b.txt into 
    txt main file
    """
    try:        
        if os.path.getsize('./14besoins/doc_suivi6/main_14b.txt'):
            print("+ File 'main_14b.txt' exist !")
            with open('./14besoins/doc_suivi6/main_14b.txt', 'a+') as namefile:
...
def lectureFic():
    with open('./14besoins/doc_suivi6/patient6_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result6.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
    subprocess.call('./14besoins/doc_suivi6/patient6_read.py')
...
importationFile('./14besoins/doc_suivi6/patient6_14b.txt', encodage='Utf-8')

importationLabo('./labo/doc_labo/result6.txt', encodage='Utf-8')
