...
def saveData():
    ...
    try:        
        if os.path.getsize('./14besoins/doc_suivi20/main_14b.txt'):
            ...
            with open('./14besoins/doc_suivi20/main_14b.txt', 'a+') as namefile:
...
def lectureFic():
    with open('./14besoins/doc_suivi20/patient20_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result20.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
    subprocess.call('./14besoins/doc_suivi20/patient20_read.py')
...
def importationFile(fichier, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'patient20_14b.txt' not exist !", outcom)
...
importationFile('./14besoins/doc_suivi20/patient20_14b.txt', encodage='Utf-8')

importationLabo('./labo/doc_labo/result20.txt', encodage='Utf-8')
