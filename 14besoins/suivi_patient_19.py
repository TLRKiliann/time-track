...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        try:
            if os.path.getsize('./14besoins/doc_suivi19/patient19_14b.txt'):
                ...
                subprocess.call('./14besoins/doc_suivi19/patient19_write.py')
        ...
        try:        
            if os.path.getsize('./labo/doc_labo/result19.txt'):
                print("+ File 'result19.txt' exist !")
        except FileNotFoundError as outcom:
            print("+ Sorry, file 'result19.txt' not exist !", outcom)
    ...
    def lectureFic(self):
        ...
        try:        
            if os.path.getsize('./labo/doc_labo/result19.txt'):
                print("+ File 'result19.txt' exist !")
                subprocess.call('./14besoins/doc_suivi19/patient19_read.py')
        except FileNotFoundError as outputcomment:
            print("+ Sorry, file 'result19.txt' not exist !", outputcomment)
            self.commentFileRecResult()
    ...
    def commentFileRecResult(self):
        self.MsgBox2msg = messagebox.showinfo("Warning", "File 'result19.txt'"
            "was not created. Check options to 'labo' !")
        self.createFileLabo()

    def createFileLabo(self):
        with open('./labo/doc_labo/result19.txt', 'w') as filelab:
            filelab.write("\n---\n")
