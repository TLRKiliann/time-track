...
def saveData():
    """
    To record data from result19.txt
...
def lectureFic():
    with open('./14besoins/doc_suivi19/patient19_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result19.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
...
def importationFile(fichier, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'patient19_14b.txt' not exist !", outcom)
...
def importationLabo(fichier2, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'result19.txt' not exist !")
        print(str(outcom))
...
importationLabo('./labo/doc_labo/result19.txt', encodage='Utf-8')
