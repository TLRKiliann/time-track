...
def saveData():
    """
    To record data from result12.txt
    and from patient12_14b.txt into 
    txt main file
    """
    try:        
        if os.path.getsize('./14besoins/doc_suivi12/main_14b.txt'):
            print("+ File 'main_14b.txt' exist !")
            with open('./14besoins/doc_suivi12/main_14b.txt', 'a+') as namefile:
...
def lectureFic():
    with open('./14besoins/doc_suivi12/patient12_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result12.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
...
def importationFile(fichier, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'patient12_14b.txt' not exist !", outcom)
...
def importationLabo(fichier2, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'result12.txt' not exist !")
        print(str(outcom))
...
importationFile('./14besoins/doc_suivi12/patient12_14b.txt', encodage='Utf-8')

importationLabo('./labo/doc_labo/result12.txt', encodage='Utf-8')
