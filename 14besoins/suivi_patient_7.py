...
class Application(Frame):
    ...
    def lienDirect(self):
        ...
        try:
            if os.path.getsize('./14besoins/doc_suivi7/patient7_14b.txt'):
                ...
                subprocess.call('./14besoins/doc_suivi7/patient7_write.py')
        ...
        try:        
            ...
            print("+ Sorry, file 'result7.txt' not exist !", outcom)
    ...
    def lectureFic(self):
        ...
        try:        
            ...
            print("+ Sorry, file 'result7.txt' not exist !", outputcomment)
            self.commentFileRecResult()
    ...
    def commentFileRecResult(self):
        self.MsgBox2msg = messagebox.showinfo("Warning", "File 'result7.txt'"
            "was not created. Check options to 'labo' !")
        self.createFileLabo()

    def createFileLabo(self):
        with open('./labo/doc_labo/result7.txt', 'w') as filelab:
            filelab.write("\n---\n")
