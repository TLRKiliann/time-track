...
def saveData():
    """
    To record data from result5.txt
    and from patient5_14b.txt into 
    txt main file
    """
    try:        
...
def lectureFic():
    with open('./14besoins/doc_suivi5/patient5_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result5.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
    subprocess.call('./14besoins/doc_suivi5/patient5_read.py')
...
def importationFile(fichier, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'patient5_14b.txt' not exist !", outcom)
...
importationFile('./14besoins/doc_suivi5/patient5_14b.txt', encodage='Utf-8')

importationLabo('./labo/doc_labo/result5.txt', encodage='Utf-8')
