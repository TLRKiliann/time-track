...
def saveData():
    """
    To record data from result2.txt
    and from patient2_14b.txt into 
    txt main file
    """
    try:        
...
def lectureFic():
    with open('./14besoins/doc_suivi2/patient2_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result2.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
...
def importationFile(fichier, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'patient2_14b.txt' not exist !", outcom)
...
importationLabo('./labo/doc_labo/result2.txt', encodage='Utf-8')
