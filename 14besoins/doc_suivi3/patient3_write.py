...
def saveData():
    """
    To record data from result3.txt
    and from patient3_14b.txt into 
    txt main file
    """
    try:        
...
def lectureFic():
    with open('./14besoins/doc_suivi3/patient3_14b.txt', 'r') as f1read:
        with open('./labo/doc_labo/result3.txt', 'r') as f2read:
            print(f1read.read())
            print(f2read.read())
    subprocess.call('./14besoins/doc_suivi3/patient3_read.py')
...
def importationFile(fichier, encodage="Utf-8"):
    ...
    try:        
        ...
        print("+ Sorry, file 'patient3_14b.txt' not exist !", outcom)
...
importationLabo('./labo/doc_labo/result3.txt', encodage='Utf-8')
