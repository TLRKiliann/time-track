...
def recordOption():
    ...
    with open('./labo/doc_labo/result8.txt', 'a+') as file:
        file.write("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
        file.write("\nDate : ")
    ...
    if CheckVar7.get()==1:
        ...
        with open('./labo/doc_labo/result7.txt', 'a+') as file:
    ...
    with open('./labo/doc_labo/result8.txt', 'a+') as endfile:
        endfile.write("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
...
def comburTips():
    subprocess.call('./labo/combtest8.py')
