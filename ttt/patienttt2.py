...
def showTreat():
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt2/convdose.json'):
            subprocess.call('./ttt/doc_ttt2/tabs.py')
...
patient 2, convdose.json file missing !") 
...
def showReserve():
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt2/convres.json'):
            subprocess.call('./ttt/doc_ttt2/tabres.py')
    except FileNotFoundError as no_tabs:
...
patient 2, convres.json file missing !")
...
def copyToFile():
    ...
    to reuse them after.
    """
    with open('./ttt/doc_ttt2/intro_ttt.txt', '+a') as file:
        file.write(str("Date : "))
...
def copyToReserve():
    ...
    to reuse them after.
    """
    with open('./ttt/doc_ttt2/intro_res.txt', '+a') as file:
        file.write(str("Date : "))
        file.write(textDate.get() + '\n')
        file.write(str("Heure : "))
        file.write(textHour.get() + '\n')
...
with open('./allergy/allergyfile2.txt', 'r') as filename2:
