...
def showTreat():
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/convdose.json'):
            subprocess.call('./ttt/doc_ttt24/tabs.py')
...
patient 24, convdose.json file missing !") 
...
def showReserve():
    ...
    try:
        if os.path.getsize('./ttt/doc_ttt24/convres.json'):
            subprocess.call('./ttt/doc_ttt24/tabres.py')
    except FileNotFoundError as no_tabs:
...
patient 24, convres.json file missing !")
...
def copyToFile():
    ...
    to reuse them after.
    """
    with open('./ttt/doc_ttt24/intro_ttt.txt', '+a') as file:
        file.write(str("Date : "))
...
def copyToReserve():
    ...
    to reuse them after.
    """
    with open('./ttt/doc_ttt24/intro_res.txt', '+a') as file:
        file.write(str("Date : "))
        file.write(textDate.get() + '\n')
        file.write(str("Heure : "))
        file.write(textHour.get() + '\n')
...
with open('./allergy/allergyfile24.txt', 'r') as filename2:
