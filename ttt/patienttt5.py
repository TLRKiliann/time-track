...
def copyToFile():
    ...
    to reuse them after.
    """
    with open('./ttt/doc_ttt5/intro_ttt.txt', '+a') as file:
        file.write(str("Date : "))
...
def copyToReserve():
    ...
    to reuse them after.
    """
    with open('./ttt/doc_ttt5/intro_res.txt', '+a') as file:
        file.write(str("Date : "))
        file.write(textDate.get() + '\n')
        file.write(str("Heure : "))
        file.write(textHour.get() + '\n')
...
def readFileStory():
    try:
        if os.path.getsize("./ttt/doc_ttt5/intro_ttt.txt"):
            subprocess.call("./ttt/doc_ttt5/readstory.py")
...
with open('./allergy/allergyfile5.txt', 'r') as filename2:
