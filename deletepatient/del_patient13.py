...
def delFuncFile13():
    try:
        if os.path.getsize('./14besoins/doc_suivi13/main_14b.txt'):
            os.remove('./14besoins/doc_suivi13/main_14b.txt')
    ...
    try:
        if os.path.getsize('./14besoins/doc_suivi13/patient13_14b.txt'):
            os.remove('./14besoins/doc_suivi13/patient13_14b.txt')
            print("+ File patient13_14b.txt deleted")
    except FileNotFoundError as filefunc28:
        print("+ File patient13_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi13.txt does not exist", filefunc28)

    try:
        if os.path.getsize('./diag/doc_diag13/diagrecap.txt'):
            os.remove('./diag/doc_diag13/diagrecap.txt')
    ...
    try:
        ...
        print("+ File result13.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile13.txt does not exist", filefunc28)
