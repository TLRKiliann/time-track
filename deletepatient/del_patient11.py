...
def delFuncFile11():
    ...
    try:
        ...
        print("+ File patient11_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi11.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File result11.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile11.txt does not exist", filefunc28)
