...
def delFuncFile24():
    ...
    try:
        ...
        print("+ File patient24_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi24.txt does not exist", filefunc28)

    try:
        if os.path.getsize('./diag/doc_diag24/diagrecap.txt'):
            os.remove('./diag/doc_diag24/diagrecap.txt')
    ...
    try:
        ...
        print("+ File result24.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile24.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File entryfile24.txt does not exist", filefunc28)
