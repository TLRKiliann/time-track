...
def delFuncFile9():
    ...
    try:
        ...
        print("+ File patient9_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi9.txt does not exist", filefunc28)

    try:
        if os.path.getsize('./diag/doc_diag9/diagrecap.txt'):
            os.remove('./diag/doc_diag9/diagrecap.txt')
    ...
    try:
        ...
        print("+ File result9.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile9.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File entryfile9.txt does not exist", filefunc28)
