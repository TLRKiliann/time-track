...
def delFuncFile19():
    ...
    try:
        ...
        print("+ File patient19_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi19.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File result19.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile19.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File entryfile19.txt does not exist", filefunc28)
