...
def delFuncFile10():
    ...
    try:
        ...
        print("+ File patient10_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi10.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File result10.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile10.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File entryfile10.txt does not exist", filefunc28)
