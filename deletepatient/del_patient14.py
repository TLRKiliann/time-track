...
def delFuncFile14():
    try:
        if os.path.getsize('./14besoins/doc_suivi14/main_14b.txt'):
            os.remove('./14besoins/doc_suivi14/main_14b.txt')
    ...
    try:
        if os.path.getsize('./14besoins/doc_suivi14/patient14_14b.txt'):
            os.remove('./14besoins/doc_suivi14/patient14_14b.txt')
            print("+ File patient14_14b.txt deleted")
    except FileNotFoundError as filefunc28:
        print("+ File patient14_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi14.txt does not exist", filefunc28)

    try:
        if os.path.getsize('./diag/doc_diag14/diagrecap.txt'):
            os.remove('./diag/doc_diag14/diagrecap.txt')
    ...
    try:
        ...
        print("+ File result14.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile14.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File entryfile14.txt does not exist", filefunc28)
