...
def delFuncFile18():
    ...
    try:
        ...
        print("+ File patient18_14b.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File bmi18.txt does not exist", filefunc28)

    try:
        if os.path.getsize('./diag/doc_diag18/diagrecap.txt'):
            os.remove('./diag/doc_diag18/diagrecap.txt')
    ...
    try:
        ...
        print("+ File result18.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File allergyfile18.txt does not exist", filefunc28)
    ...
    try:
        ...
        print("+ File entryfile18.txt does not exist", filefunc28)
