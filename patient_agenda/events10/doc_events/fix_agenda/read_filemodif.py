...
def saveData():         
    with open('./patient_agenda/events10/doc_events/fix_agenda/modifrdv.txt', 'w') as textfile2:
...
importationFile('./patient_agenda/events10/doc_events/fix_agenda/modifrdv.txt')
