...
def saveData():         
    with open('./patient_agenda/events19/doc_events/fix_agenda/modifrdv.txt', 'w') as textfile2:
...
importationFile('./patient_agenda/events19/doc_events/fix_agenda/modifrdv.txt')
