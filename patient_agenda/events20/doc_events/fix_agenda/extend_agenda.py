...
def retrieve_input():
    ...
    print(inputValue)
    file = open('./patient_agenda/events20/doc_events/fix_agenda/fixed_rdv.txt', 'a+')
...
def lectureFic():
    file = open('./patient_agenda/events20/doc_events/fix_agenda/fixed_rdv.txt', 'r')
    print(file.read())
    file.close()
    subprocess.call('./patient_agenda/events20/doc_events/fix_agenda/read_file.py')
...
def changeText():
    subprocess.call('./patient_agenda/events20/doc_events/fix_agenda/main.py')
...
importationFile('./patient_agenda/events20/doc_events/fix_agenda/patient_value.json')
