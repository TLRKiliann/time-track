...
def searchExpress():
    ...
    """
    mot = regexpi_var.get()
    with open('./patient_agenda/events15/doc_events/fix_agenda/fixed_rdv.txt', 'r') as textfile1:
    ...
    with open('./patient_agenda/events15/doc_events/fix_agenda/modifrdv.txt', 'r') as textfile2:
...
def save_input():
    ...
    with open('./patient_agenda/events15/doc_events/fix_agenda/fixed_rdv.txt', 'r') as fr:
        with open('./patient_agenda/events15/doc_events/fix_agenda/modifrdv.txt', 'a+') as fw1:
            with open('./patient_agenda/events15/doc_events/fix_agenda/fixed_rdv.txt', 'a+') as fw2:
...
def modifList():
    ...
    """
    subprocess.call('./patient_agenda/events15/doc_events/fix_agenda/read_filemodif.py')
