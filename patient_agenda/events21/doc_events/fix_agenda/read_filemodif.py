...
def saveData():         
    with open('./patient_agenda/events21/doc_events/fix_agenda/modifrdv.txt', 'w') as textfile2:
...
try:
    importationFile('./patient_agenda/events21/doc_events/fix_agenda/modifrdv.txt')
